...
const is_staging = process.env.NEXT_PUBLIC_APP_URL?.includes('staging')
  ...
  return (
    toArray(response)
      ...
      .map(a => {
        ...
        return {
          ...a,
          addresses: Object.fromEntries(Object.entries({ ...addresses }).filter(([k, v]) => !v.is_staging || is_staging)),
        }
      })
  )
}
