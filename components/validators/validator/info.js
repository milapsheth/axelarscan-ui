          ...
          <div className="flex items-start space-x-2.5">
            ...
            <div className="flex flex-col space-y-0.5 sm:space-y-0">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-0.5 sm:space-y-0">
                <span className="text-base lg:text-lg font-medium sm:mr-3">
                  {ellipse(moniker, 16)}
                </span>
                <div className="flex items-center space-x-1">
                  {status && (
                    <Chip
                      ...
                      className="rounded select-auto normal-case custom-font text-2xs font-medium py-0.5 px-1.5"
                    />
                  )}
                  {tombstoned && (
                    <Chip
          ...
          {data ?
            <div className="flex flex-col space-y-1">
              <div className="flex items-center space-x-2">
                <span className="w-24 text-slate-600 dark:text-slate-400 text-sm lg:text-base font-medium">
                  Consensus:
                </span>
                <div className="flex items-center space-x-1">
                  <NumberDisplay
      ...
      <div className="sm:bg-slate-50 sm:dark:bg-slate-900 sm:flex sm:flex-col sm:rounded-lg sm:space-y-4 sm:p-6">
        {delegations ?
          <Datatable
            ...
            noPagination={_delegations.length <= 10}
            className={`${_delegations.length >= 10 ? 'delegations-table' : ''} no-border no-shadow`}
          /> :
