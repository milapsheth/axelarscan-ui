  ...
  useEffect(
    () => {
      const trigger = is_interval => {
        if (pathname && chains_data && filters) {
              ...
              },
              {
                ...
                Cell: props => props.value && (
                  <Copy
                    ...
                    value={props.value}
                    title={
                      <span className="cursor-pointer text-slate-400 dark:text-slate-500 text-xs">
                            ...
                            <div key={i} className="flex flex-wrap items-start">
                              ...
                              {account ?
                                <div className="flex items-center space-x-1 mr-2">
                                  <BsArrowRightShort size={18} />
                                  <div className="flex items-center space-x-1">
                                    <AccountProfile address={account} url={explorer && `${explorer.url}${explorer.address_path?.replace('{address}', account)}`} />
                              ...
                              {newOwners && (
                                <NumberDisplay
                                  ...
                                  suffix={' New Owners'}
                                  noTooltip={true}
                                  className="bg-slate-50 dark:bg-slate-900 rounded-lg whitespace-nowrap text-white text-xs font-medium mr-2 py-1 px-1.5"
                                />
                              )}
                              {newOperators && (
                                <div className="flex items-center mr-2">
                                  <NumberDisplay
                                    ...
                                    noTooltip={true}
                                    className="bg-slate-50 dark:bg-slate-900 rounded-lg whitespace-nowrap text-white text-xs font-medium mr-1 py-1 px-1.5"
                                  />
                                  {newWeights && (
                                    <NumberDisplay
