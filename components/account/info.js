...
export default ({ address, data }) => {
                          ...
                          <div className="min-w-max flex items-center space-x-2">
                            ...
                            <div className="flex flex-col">
                              <Link
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-400 font-medium text-xs sm:text-sm"
                              >
  ...
  const titleClassName = 'w-40 lg:w-52 tracking-wider text-slate-600 dark:text-slate-400 text-sm lg:text-base font-medium'
            ...
            destination_chain_data ?
              <div className="flex items-start space-x-2">
                ...
                <div className="flex flex-col">
                  ...
                  {recipient_address && (
                    <div className="flex items-center space-x-1">
                      <AccountProfile address={recipient_address} url={destination_chain_data.explorer && `${destination_chain_data.explorer.url}${destination_chain_data.explorer.address_path?.replace('{address}', recipient_address)}`} />
